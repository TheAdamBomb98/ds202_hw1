...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi, my name is **Adam Ford** I am majoring in *Software Engineering* with a minor in Data Science. I am originally from Eagan, Minnesota. Outside of school I spend time playing Spikeball and disc golf with my friends. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    ![General Mills Logo](GMI.jpg)  
    Answer: A job that is related to Data Science would be a Data Scientist at General Mills. They are responsible for designing models that help other aspects of the business predict trends in sales and other metrics. [More information can be found here](https://careers.generalmills.com/)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am interested in sports data primarily. Any sport data can be interesting to me, I am not picky.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: version 2.25.1.windows.1
